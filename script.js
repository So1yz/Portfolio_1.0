const translations = {
  nl: {
    ...
    "exp.pathe": "Geholpen in een drukke omgeving waar snelheid en klantvriendelijkheid belangrijk zijn. Ik leerde omgaan met verschillende soorten mensen en efficiënt werken onder druk.",
    "exp.kofteci": "Als bezorger verantwoordelijk voor snelle en correcte leveringen. Zelfstandig gewerkt en geleerd om met tijdsdruk en verantwoordelijkheid om te gaan. Maar een maand vanwege winter.",
    "exp.serifoglu": "Gewerkt in een Turkse dessertzaak waar ik verschillende taken uitvoerde, zoals bediening, klanten helpen en het serveren van producten. Ervaring opgedaan in klantgericht werken, samenwerken en omgaan met drukte.",
  ...
  en: {
   ...
   "nav.ervaringen": "Experiences",
    ...
    "ervaringen.title": "Experiences",
    "exp.pathe": "Worked in a busy environment where speed and customer friendliness were important. Learned to deal with different types of people and work efficiently under pressure.",
    "exp.kofteci": "Responsible for fast and correct deliveries as a courier. Worked independently and learned to handle time pressure and responsibility. Only for one month due to winter.",
    "exp.serifoglu": "Worked in a Turkish dessert shop performing various tasks such as serving customers and handling orders. Gained experience in customer service, teamwork, and working under pressure.",
